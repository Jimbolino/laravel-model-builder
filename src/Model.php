...
class Model
{
    ...
    public function createModel()
    {
        ...
        $file .= 'use Illuminate\Database\Eloquent\Model;' . LF;
        ...
        // $file .= '/**' . LF;
        $file .= ' /**' . LF;
        $file .= ' * The table associated with the model ' . $this->class . LF;
        $file .= ' *' . LF;
        $file .= ' * @var string' . LF;
        $file .= ' */' . LF;
        ...
        if (!$this->timestamps) {
            ...
            // $file .= '/**' . LF;
            $file .= ' /**' . LF;
            $file .= ' * Indicates if the model should be timestamped.' . LF;
            $file .= ' *' . LF;
            $file .= ' * @var bool' . LF;
            $file .= ' */' . LF;
        ...
        $file .= ' /**' . LF;
        $file .= ' * The attributes that are mass assignable.' . LF;
        $file .= ' *' . LF;
        $file .= ' * @var array' . LF;
        $file .= ' */' . LF;
        ...
        if (!empty($this->hidden)) {
            $file .= ' /**' . LF;
            $file .= ' * The attributes that should be hidden for arrays.' . LF;
            $file .= ' *' . LF;
            $file .= ' * @var array' . LF;
            $file .= ' */' . LF;
